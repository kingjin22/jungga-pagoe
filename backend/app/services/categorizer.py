...
RULES = [
    ...
    # ── 반려동물 ────────────────────────────────────────────────────
    ("반려동물",     ["사료", "강아지사료", "고양이사료", "펫푸드", "펫사료", "개사료",
                      "고양이모래", "猫砂", "캣푸드", "독푸드", "펫간식", "강아지간식",
                      "고양이간식", "반려동물", "펫", "하림펫", "냠냠캣", "모찌네",
                      "반려견", "반려묘", "고양이", "강아지"]),
    # ── 자동차 ──────────────────────────────────────────────────────
    ("자동차",       ["발수코팅", "유막제거", "에어컨필터", "차량용", "자동차", "카필터",
                      "블랙박스", "하이패스", "타이어", "엔진오일", "글라코", "윈터블레이드",
                      "차량청소", "방향제 차량"]),
    # ── 완구/레저 ───────────────────────────────────────────────────
    ("완구/레저",    ["너프건", "호버샷", "레고", "건프라", "프라모델", "완구", "장난감",
                      "에버랜드", "리조트", "테마파크", "숙박", "룸온리", "오크밸리",
                      "놀이공원", "워터파크", "식사권", "이용권", "상품권"]),
    # ── 구강/위생 ───────────────────────────────────────────────────
    ("구강/위생",    ["치약", "칫솔", "구강청결제", "가글", "치실", "전동칫솔",
                      "소독제", "손소독", "살균", "항균", "소독"]),
    # ── 소프트웨어/구독 ──────────────────────────────────────────────
