...
# ─── 식품/일상용품 금지 키워드 ───────────────────────────────────────────────
FOOD_TITLE_KEYWORDS = [
    "라면", "과자", "음료", "주스", "우유", "치즈", "햄", "참치", "소시지",
    "빵", "케이크", "초콜릿", "사탕", "젤리", "과자", "오징어", "새우", "김",
    "쌀", "고기", "삼겹살", "닭고기", "돼지고기", "소고기", "김치", "된장",
    "간장", "고추장", "식용유", "밀가루", "설탕", "소금", "카페", "커피",
    "홍차", "녹차", "에너지드링크", "파워에이드", "게토레이", "콜라", "사이다",
    "맥주", "소주", "와인", "막걸리", "족발", "보쌈", "치킨", "피자", "버거",
    "당면", "국수", "파스타", "즉석밥", "햇반", "컵라면", "떡", "떡볶이",
    "계란", "달걀", "두부", "콩나물", "감자", "고구마", "양파", "마늘",
    "수박", "포도", "딸기", "바나나", "망고", "복숭아", "사과", "배",
    "비타민", "유산균", "프로바이오틱스", "콜라겐", "오메가", "홍삼", "인삼",
    "멜라토닌", "루테인", "마그네슘",  # 건강기능식품
    "기저귀", "물티슈", "세제", "샴푸", "린스", "바디워시", "치약", "칫솔",
    "화장지", "롤화장지", "키친타월", "비누", "락스", "청소",
]
...
async def lookup_msrp_from_naver(title: str, sale_price: int) -> Optional[dict]:
    ...
    # 제목 전처리: 쇼핑몰 태그 제거 ([네이버], [쿠팡] 등), 괄호 제거
    clean = re.sub(r"\[.*?\]", "", title).strip()
    clean = re.sub(r"\(.*?\)", "", clean).strip()
    # 수량/용량 제거 (g, ml, 개입 등은 두되 너무 긴 부분 제거)
    clean = clean[:40]  # Naver 검색 최대 40자
