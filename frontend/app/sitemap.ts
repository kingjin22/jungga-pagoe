...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/overseas`, lastModified: now, changeFrequency: "hourly" as const, priority: 0.8 },
    { url: `${BASE_URL}/gaming`, lastModified: now, changeFrequency: "hourly" as const, priority: 0.8 },
